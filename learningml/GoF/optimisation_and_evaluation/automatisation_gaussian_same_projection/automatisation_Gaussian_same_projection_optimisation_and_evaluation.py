...
directory_name = "_gauss_final_2files_plot"
...
#expt.evaluate(evaluation_dimensions = range(2,11), number_of_evaluations=2)

end_time = time.time()

print(50*"-"+"\nevaluation took  ", (end_time - evaluation_start_time)/60. , "  minutes\n" +50*"-")

expt.plot(plot_dimensions=[2,6,10],most_typical=[79, 74, 22])
