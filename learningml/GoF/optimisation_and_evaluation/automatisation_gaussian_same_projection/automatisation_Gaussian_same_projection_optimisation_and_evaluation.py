...
nclf_list = [nclf('nn',"no classifier needed for nn", ['n_hidden_layers','dimof_middle'], [[0,1],[100,500]],param_opt=[0,50])]
#nclf_list = [nclf()]
...
title_CPV = "Gauss 1.0 0.75"
title_noCPV="Gauss 1.0 1.0" 

expt = experiment(nclf_list=nclf_list, file_name_patterns=file_name_patterns, scoring='chi2',single_no_bins_list = [3,4], only_mod=True,title_CPV=title_CPV, title_noCPV=title_noCPV)

#expt.optimise(optimisation_dimension = 4, number_of_iterations=10)


expt.evaluate(evaluation_dimensions = range(2,3), number_of_evaluations=3)
