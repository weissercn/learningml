...
if CPV:	
	orig_name="sin_5_6_10000_CPV_syst_"+str(systematics_fraction).replace(".","_")+"_1Dproj_"
	orig_title="sin 5 and 6 syst{} 1Dproj".format(systematics_fraction)

else: 
        orig_name="sin_5_5_10000_noCPV_syst_"+str(systematics_fraction).replace(".","_")+"_1Dproj_"
        orig_title="sin 5 and 5 syst{} 1Dproj".format(systematics_fraction)
...
for dim_data_index, dim_data in enumerate(dim_list):
	comp_file_list=[]
		...
		if CPV: 
			comp_file_list.append((os.environ['learningml']+"/GoF/data/accept_reject/sin1diff_1Dproj_data/data_sin1diff_5_and_5_periods{0}D_10000_sample_{1}_1Dproj.txt".format(dim_data,i), os.environ['learningml']+"/GoF/data/accept_reject/sin1diff_1Dproj_data/data_sin1diff_5_and_6_periods{0}D_10000_sample_{1}_1Dproj.txt".format(dim_data,i)))
		else: 
			comp_file_list.append((os.environ['learningml']+"/GoF/data/accept_reject/sin1diff_1Dproj_data/data_sin1diff_5_and_5_periods{0}D_10000_sample_{1}_1Dproj.txt".format(dim_data,i), os.environ['learningml']+"/GoF/data/accept_reject/sin1diff_1Dproj_data/data_sin1diff_5_and_5_periods{0}D_10000_sample_1{1}_1Dproj.txt".format(dim_data,str(i).zfill(2))))
