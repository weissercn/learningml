...
if CPV:	
	orig_name="event_shapes_lower_level_syst_"+str(systematics_fraction).replace(".","_")+"_"
...
for param in param_list:
	...
	for i in range(100):
		if CPV: 
			comp_file_list.append((os.environ['monash']+"/GoF_input/GoF_input_udsc_monash_lower_level_{1}.txt".format(dim_data,i), os.environ['monash']+"/GoF_input/GoF_input_udsc_"+str(param)+"_"+param_name_list[0]+"_lower_level_{1}.txt".format(dim_data,i)))


		else: 
			comp_file_list.append((os.environ['monash']+"/GoF_input/GoF_input_udsc_monash_lower_level_{1}.txt".format(dim_data,i), os.environ['monash']+"/GoF_input/GoF_input_udsc_monash_lower_level_1{1}.txt".format(dim_data,str(i).zfill(2))))
