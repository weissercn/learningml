...
for no_dim in dim_list:
	for i in range(number_of_files):
		...
		#          ./generate_gaussian_samples.py  		no_samples  loc_centre  sigma varysigma2  sigmas perp  no_dim 	nth file	optimisation mode	rotated imperfectly   	REDEF_SIGMA_PERP
		os.system("./generate_gaussian_samples_varysigma2.py  	10000        0.0         0.90             1.0 		{0}      {1} 		{2}			1			0".format(no_dim,i,optimisation_mode)) 
