...
if MODE == 'lower_level':
	...
	if True:
		...
		ax.errorbar(param_list,ml_classifiers_dict['nn'], xerr=(xwidth_left, xwidth_right), yerr=binomial_error(ml_classifiers_dict['nn']), linestyle='', marker='s', markersize=15, color='green', ecolor='blue', label=r'$ANN$', clip_on=False)
		...
		ax.errorbar(param_list,ml_classifiers_dict['BDT_best'], xerr=(xwidth_left, xwidth_right), yerr=binomial_error(ml_classifiers_dict['BDT_best']), linestyle='', marker='o', markersize=15, color='green', ecolor='blue', label=r'$BDT$', clip_on=False)
		ax.errorbar(param_list,ml_classifiers_dict['svm'], xerr=(xwidth_left, xwidth_right), yerr=binomial_error(ml_classifiers_dict['svm']),  linestyle='', marker='^', markersize=15, color='green', ecolor='blue', label=r'$SVM$', clip_on=False)
