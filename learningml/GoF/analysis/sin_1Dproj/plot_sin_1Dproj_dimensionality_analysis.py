...
if MODE == 'Sin':
	...
	ml_classifiers_colors   = ['blue','black','green']
        ...
        chi2_folder_name        = "sin_1Dproj"

        ml_file_name            = "{1}_{0}Dsin_5_6_10000_CPV_syst_0_01__chi2scoring_{2}_p_values"
        chi2_file_name          = "sin_5_6_10000_CPV_syst_0_01_1Dproj__{0}D_chi2_{1}_splits_p_values"
...
if MODE == 'Sin_noCPV':
	...
	ml_classifiers_colors   = ['blue','black','green']
        ...
        chi2_file_name          = "sin_5_5_10000_noCPV_syst_0_01_1Dproj__{0}D_chi2_{1}_splits_p_values"
