...
if MODE == 'lower_level':
	...
	#chi2_splits		= [8]
        ...
        #ml_without_Mult_folder_name          = "automatisation_monash_alphaSvalue_lower_level_without_mult_pSum/evaluation_monash_lower_level_without_Mult_pSum_2files_attempt4"
	ml_without_Mult_folder_name          = "automatisation_monash_alphaSvalue_lower_level_without_mult_pSum/evaluation_monash_lower_level_without_Mult_pSum_2files_attempt4_nocrossval"
	chi2_folder_name        = "event_shapes_lower_level"
	chi2_without_Mult_folder_name        = "event_shapes_lower_level_without_Mult_pSum"

	ml_file_name            = "{1}_monash_{0}_alphaSvalue_lower_level_syst_0_01__p_values"
        #ml_without_Mult_file_name            = "{1}_monash_{0}_alphaSvalue_lower_level_without_Mult_pSum_syst_0_01__p_values"
        ml_without_Mult_file_name            = "{1}_monash_{0}_alphaSvalue_lower_level_without_Mult_pSum_syst_0_01__chi2scoring_5_p_values"
	chi2_file_name          = "event_shapes_lower_level_syst_0_01_attempt4__{0}D_chi2_{1}_splits_p_values"
	chi2_without_Mult_file_name          = "event_shapes_lower_level_syst_0_01_attempt4_without_Mult_pSum__{0}D_chi2_{1}_splits_p_values"
	chi2_without_Mult_uniform_file_name          = "event_shapes_lower_level_uniform_syst_0_01_attempt4_without_Mult_pSum__{0}D_chi2_{1}_splits_p_values"
	...
	if True:
		...
		#ax.errorbar(param_list,ml_classifiers_dict['svm'], yerr=binomial_error(ml_classifiers_dict['svm']),  linestyle='-', marker='^', markeredgewidth=0.0, markersize=12, color=ml_classifiers_colors[2], label=r'$SVM$', clip_on=False)
                ...
                for ml_classifier_index, ml_classifier in enumerate(ml_classifiers):
                        ...
                        for param in param_list_without_Mult:
                ...
                print("bdt : ", ml_classifiers_dict['bdt'])
                ax.errorbar(param_list_without_Mult,ml_without_Mult_classifiers_dict['bdt'], yerr=binomial_error(ml_without_Mult_classifiers_dict['bdt']), linestyle='-', marker='o', markeredgewidth=0.0, markersize=12, color=ml_classifiers_colors[0], label=r'$bdt 6D$', clip_on=False)
		ax.errorbar(param_list_without_Mult,ml_without_Mult_classifiers_dict['nn'], yerr=binomial_error(ml_without_Mult_classifiers_dict['nn']), linestyle='-', marker='o', markeredgewidth=0.0, markersize=12, color=ml_classifiers_colors[2], label=r'$nn 6D$', clip_on=False)
	...
	ax.errorbar(param_list,chi2_without_Mult_best, yerr=binomial_error(chi2_without_Mult_best), linestyle='--', marker='$\chi$', markeredgecolor='none', markersize=18, color='grey', label=r'$\chi^2 6D$',     clip_on=False)
	ax.errorbar(param_list,chi2_without_Mult_uniform_best, yerr=binomial_error(chi2_without_Mult_uniform_best), linestyle='--', marker='$\chi$', markeredgecolor='none', markersize=18, color='blue', label=r'$\chi^2 6D unif$',     clip_on=False)
	...
	#fig_name=name+"_alphaSvalue_analysis"
        fig_name="event_shapes_lower_level_without_mult_analysis"
