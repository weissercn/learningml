...
if MODE == 'lower_level':
	...
	#chi2_splits		= [8]
        ...
        ml_without_Mult_folder_name          = "automatisation_monash_alphaSvalue_6D_thrust/evaluation_monash_6D_thrust"
	chi2_folder_name        = "event_shapes_lower_level"
	chi2_without_Mult_folder_name        = "event_shapes_6D_thrust"

	ml_file_name            = "{1}_monash_{0}_alphaSvalue_lower_level_syst_0_01__p_values"
        ml_without_Mult_file_name            = "{1}_monash_{0}_alphaSvalue_6D_thrust_syst_0_01__p_values"
        chi2_file_name          = "event_shapes_lower_level_syst_0_01_attempt4__{0}D_chi2_{1}_splits_p_values"
	chi2_without_Mult_file_name          = "event_shapes_6D_thrust_syst_0_01__{0}D_chi2_{1}_splits_p_values"
	...
	if True:
		...
		#ax.errorbar(param_list,ml_classifiers_dict['svm'], yerr=binomial_error(ml_classifiers_dict['svm']),  linestyle='-', marker='^', markeredgewidth=0.0, markersize=12, color=ml_classifiers_colors[2], label=r'$SVM$', clip_on=False)
                ...
                print("bdt : ", ml_classifiers_dict['bdt'])
                ax.errorbar(param_list_without_Mult,ml_without_Mult_classifiers_dict['bdt'], yerr=binomial_error(ml_without_Mult_classifiers_dict['bdt']), linestyle='-', marker='o', markeredgewidth=0.0, markersize=12, color=ml_classifiers_colors[0], label=r'$bdt 6D+thrust$', clip_on=False)
	...
	ax.errorbar(param_list,chi2_without_Mult_best, yerr=binomial_error(chi2_without_Mult_best), linestyle='--', marker='$\chi$', markeredgecolor='none', markersize=18, color='grey', label=r'$\chi^2 6D+thrust$',     clip_on=False)
	...
	plt.xticks(xx, ll)
        ...
        fig_name="event_shapes_lower_level_6D_thrust_analysis"
