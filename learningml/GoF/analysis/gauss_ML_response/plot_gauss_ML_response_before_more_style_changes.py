...
if MODE == 'Gauss1':
	...
	for dim in dimensions:
		...
		for ml_classifier_index, ml_classifier in enumerate(ml_classifiers):
			...
			ax.errorbar(bin_middle, hist0, xerr=xwidths, yerr=hist0_sqrt, linestyle='', marker=marker_f1, markersize=10, markeredgewidth=0.0, color=col_f1[ml_classifier_index], ecolor=col_f1[ml_classifier_index], label=ml_classifiers_labels[ml_classifier_index])
			ax.errorbar(bin_middle, hist1, xerr=xwidths, yerr=hist1_sqrt, linestyle='', marker=marker_f2, markersize=10, markeredgewidth=0.0, color=col_f2[ml_classifier_index], ecolor=col_f2[ml_classifier_index])
