...
if MODE == 'lower_level':
	...
	#chi2_splits		= [8]
        ...
        ml_folder_name          = "automatisation_monash_alphaSvalue_thrust_jetcomp_final_state/evaluation_final_state_thrust_jetcomp"
        chi2_folder_name        = "event_shapes_jetcomp_final_state"
	#chi2_folder_name        = "event_shapes_lower_level_without_Mult"

        ml_file_name            = "{1}_monash_{0}_alphaSvalue_final_state_thrust_jetcomp_syst_0_01__chi2scoring_5_p_values"
        chi2_file_name          = "event_shapes_final_state_thrust_jetcomp_scale_uniform_syst_0_01__{0}D_chi2_{1}_splits_p_values"
	...
	plt.figlegend(*ax.get_legend_handles_labels(), loc = 'upper left',frameon=False, numpoints=1,ncol=2)
        ...
        fig_name="event_shapes_thrust_jetcomp_final_state_analysis"
